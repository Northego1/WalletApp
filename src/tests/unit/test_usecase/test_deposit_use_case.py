...
from WalletApp.src.core.wallet_exceptions import WalletDepositError
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (mock_balance_dto.wallet_id, 0, None, WalletDepositError),
    ],
)
async def test_wallet_deposit_use_case(
    ...
    if exception:
        ...
        assert (
            await wallet_deposit_use_case.operation(wallet_id=wallet_id, amount=amount)
            == expection
        )
